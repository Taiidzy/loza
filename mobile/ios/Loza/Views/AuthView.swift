...
//  Loza
//
//  Login screen with vivid glass card, particle background, alive states.
//
...
struct AuthView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // Vivid decorative blobs
            Circle()
                .fill(RadialGradient(colors: [LozaColor.accentPurple.opacity(0.22), .clear], center: .center, startRadius: 0, endRadius: 210))
            ...
            Circle()
                .fill(RadialGradient(colors: [LozaColor.accentPink.opacity(0.18), .clear], center: .center, startRadius: 0, endRadius: 160))
    ...
    private var loginCard: some View {
        ...
        .overlay(
            RoundedRectangle(cornerRadius: LozaMetrics.sheetRadius)
                .stroke(
                    LinearGradient(
                        colors: [LozaColor.accentPink.opacity(0.25), LozaColor.accentPurple.opacity(0.15), LozaColor.accentBlue.opacity(0.1)],
                ...
                if hasEye {
                    Button {
                        ...
                        Image(systemName: showPassword ? "eye" : "eye.slash")
                            .font(.system(size: 14))
                            .foregroundStyle(showPassword ? LozaColor.accentPink.opacity(0.6) : .white.opacity(0.22))
                    }
                }
            }
        }
