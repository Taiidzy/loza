/**
 * Набор простых SVG-иконок для навигации и интерфейса.
 * Все иконки — line-style (stroke, без заливки), унаследовано от Feather Icons.
 */
...
export function EyeIcon({ open, size = 14 }: IconProps & { open: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
/** Иконка галочки — используется, например, при успешном логине. */
...
/** Иконка ссылки для раздела "Общие ссылки". */
